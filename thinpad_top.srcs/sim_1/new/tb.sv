...
parameter BASE_RAM_INIT_FILE = //"E:\\nscscc2020\\sim\\kernel.bin";
"E:\\nscscc2020\\mainline\\asm\\user-sample.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
//"E:\\nscscc2020\\supervisor_v2.01\\kernel\\kernel.bin";
parameter EXT_RAM_INIT_FILE = //"E:\\nscscc2020\\testcase\\eram.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
"E:\\nscscc2020\\template\\qsort-data.bin";
parameter FLASH_INIT_FILE = "E:\\nscscc2020\\testcase\\flash.bin";    //Flash初始化文件，请修改为实际的绝对路径
